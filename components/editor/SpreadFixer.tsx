...
export function SpreadFixer() {
  ...
  useEffect(() => {
    ...
    if (s15 && s15.leftPage) {
      const leftHistory = s15.leftPage.elements.find((el: any) => el.src === "/assets/historyLayer.PNG");
      if (leftHistory) {
    ...
    if (s15 && s15.rightPage) {
      const rightHistory = s15.rightPage.elements.find((el: any) => el.src === "/assets/historyLayer.PNG");
      if (rightHistory) {
